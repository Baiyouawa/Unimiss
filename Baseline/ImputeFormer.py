...
output_dir = Path("outputs/imputeformer")
...
for seed in run_seeds:
    ...
    imputeformer.fit(train_set, val_set)

    imputation = imputeformer.impute(test_set)
    ...
    manual_save_path = seed_dir / "manually_saved_imputeformer_model"
    imputeformer.save(saving_path=str(manual_save_path), overwrite=True)
    imputeformer.load(f"{manual_save_path}.pypots")
...
write_result_md("ImputeFormer", agg)