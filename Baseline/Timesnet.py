...
output_dir = Path("outputs/timesnet")
...
for seed in run_seeds:
    ...
    timesnet.fit(train_set, val_set)

    imputation = timesnet.impute(test_set)
    ...
    manual_save_path = seed_dir / "manually_saved_timesnet_model"
    timesnet.save(saving_path=str(manual_save_path), overwrite=True)
    timesnet.load(f"{manual_save_path}.pypots")
