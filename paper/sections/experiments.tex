...
Metrics are MAE, RMSE, MRE, and NRMSE. NRMSE is the normalized root mean squared error and complements MRE by describing relative L2 imputation error without point-wise division by near-zero targets. We use seeds $\{3407,3408,3409\}$ and report per-seed plus average performance. The output pipeline stores both seed-wise and aggregated artifacts in a unified directory layout for reproducibility.
